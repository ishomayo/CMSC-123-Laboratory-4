% Example script to run Grey Wolf Optimization for Neural Network
% This is a simpler script that you can use to test the implementation
...
max_iter = 30;           % Maximum iterations (increase for better results)
